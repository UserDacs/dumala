...
<div class="row" style="margin-right: 18px !important; margin-left: 5px !important;">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Edit Liturgical Service</li>
    </ol>
    <!-- END breadcrumb -->
    <!-- BEGIN page-header -->
    <h1 class="page-header">Edit Liturgical Service <small></small></h1>
            ...
            <form action="/" method="POST" id="liturgicalForm">
                <fieldset>
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" id="liturgicalName" value="{{ $liturgical->title}}" name="title"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control content_text" id="editor1" name="requirements"
                            style="border: 1px solid #d2d3d3" name="content" rows="3" > {{ $liturgical->requirements}}</textarea>
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="liturgicalName">Stipend:</label>
                        <input class="form-control w-25" name="stipend" type="number" id="stipend"
                            placeholder="Enter Stipend" value="{{ $liturgical->stipend}}"/>
                    </div>
...
$("#liturgicalForm").submit(function(e) {
    ...
    $.ajax({
        ...
        success: function(response) {
            alert("Liturgical update successfully!");
